...
#high_volume_vehicle_directory = 'E:\ITI\Case Study - TAXI\\high\\'
...
#high_volume_vehicle_topic = 'high_volume_vehicle_topic'
...
def read_data(directory):
    ...
    #data = data.fillna(0.0)  # Fill missing values with 0.0
    return data
...
#high_volume_vehicle_data = read_data(high_volume_vehicle_directory)
...
while True:
    ...
    #high_volume_vehicle_records = random.randint(100 , 500)
    ...
    #high_volume_vehicle_pushed_data=high_volume_vehicle_data.head(high_volume_vehicle_records).to_dict(orient='records')
    ...
    #push_to_kafka(high_volume_vehicle_topic, high_volume_vehicle_pushed_data)
    ...
    #high_volume_vehicle_data = high_volume_vehicle_data.iloc[high_volume_vehicle_data:]
